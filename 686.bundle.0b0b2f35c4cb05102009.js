(self["webpackChunk_apicurio_registry_ui"] = self["webpackChunk_apicurio_registry_ui"] || []).push([[686,297],{
...
// EXTERNAL MODULE: ./node_modules/@patternfly/react-table/node_modules/tslib/tslib.es6.js
var tslib_es6 = __webpack_require__(90637);
...
// EXTERNAL MODULE: consume shared module (default) @patternfly/react-core@=4.121.1 (strict) (fallback: ./node_modules/@patternfly/react-table/node_modules/@patternfly/react-core/dist/esm/index.js)
var index_js_ = __webpack_require__(21242);
...
const TableComposableBase = (_a) => {
    var _b, _c;
    var { children, className, variant, borders = true, isStickyHeader = false, gridBreakPoint = TableGridBreakpoint.gridMd, 'aria-label': ariaLabel, role = 'grid', innerRef, ouiaId, ouiaSafe = true, isTreeTable = false } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["children", "className", "variant", "borders", "isStickyHeader", "gridBreakPoint", 'aria-label', "role", "innerRef", "ouiaId", "ouiaSafe", "isTreeTable"]);
...
const TheadBase = (_a) => {
    var { children, className, noWrap = false, innerRef } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["children", "className", "noWrap", "innerRef"]);
    return (index_js_eager_.createElement("thead", Object.assign({ className: (0,esm/* css */.i)(className, noWrap && table/* default.modifiers.nowrap */.Z.modifiers.nowrap), ref: innerRef }, props), children));
};
...
const TbodyBase = (_a) => {
    var { children, className, isExpanded, innerRef } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["children", "className", "isExpanded", "innerRef"]);
    return (index_js_eager_.createElement("tbody", Object.assign({ role: "rowgroup", className: (0,esm/* css */.i)(className, isExpanded && table/* default.modifiers.expanded */.Z.modifiers.expanded), ref: innerRef }, props), children));
};
...
const TrBase = (_a) => {
    var { children, className, isExpanded, isEditable, isHidden = false, innerRef, ouiaId, ouiaSafe = true } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["children", "className", "isExpanded", "isEditable", "isHidden", "innerRef", "ouiaId", "ouiaSafe"]);
    const ouiaProps = (0,index_js_.useOUIAProps)('TableRow', ouiaId, ouiaSafe);
    return (index_js_eager_.createElement("tr", Object.assign({ className: (0,esm/* css */.i)(className, isExpanded !== undefined && table/* default.tableExpandableRow */.Z.tableExpandableRow, isExpanded && table/* default.modifiers.expanded */.Z.modifiers.expanded, isEditable && inline_edit/* default.modifiers.inlineEditable */.Z.modifiers.inlineEditable), hidden: isHidden || (isExpanded !== undefined && !isExpanded), ref: innerRef }, ouiaProps, props), children));
};
...
;// CONCATENATED MODULE: ./node_modules/@patternfly/react-table/node_modules/@patternfly/react-icons/dist/esm/icons/help-icon.js
...
const HelpIcon = (0,createIcon/* createIcon */.IU)(HelpIconConfig);

/* harmony default export */ const help_icon = (HelpIcon);
...
const TableText = (_a) => {
    var { children = null, className = '', variant = 'span', wrapModifier = null, tooltip: tooltipProp = '', tooltipProps = { entryDelay: 1000 }, onMouseEnter: onMouseEnterProp = () => { } } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["children", "className", "variant", "wrapModifier", "tooltip", "tooltipProps", "onMouseEnter"]);
    ...
    const text = (index_js_eager_.createElement(Component, Object.assign({ onMouseEnter: onMouseEnter, className: (0,esm/* css */.i)(className, wrapModifier && table/* default.modifiers */.Z.modifiers[wrapModifier], table/* default.tableText */.Z.tableText) }, props), children));
...
const HeaderCellInfoWrapper = ({ children, info, className, variant = 'tooltip', popoverProps, tooltipProps, ariaLabel }) => (index_js_eager_.createElement("div", { className: (0,esm/* css */.i)(table/* default.tableColumnHelp */.Z.tableColumnHelp, className) },
    typeof children === 'string' ? index_js_eager_.createElement(TableText, null, children) : children,
    index_js_eager_.createElement("span", { className: (0,esm/* css */.i)(table/* default.tableColumnHelpAction */.Z.tableColumnHelpAction) }, variant === 'tooltip' ? (index_js_eager_.createElement(index_js_.Tooltip, Object.assign({ content: info }, tooltipProps),
        index_js_eager_.createElement(index_js_.Button, { variant: "plain", "aria-label": ariaLabel || (typeof info === 'string' && info) || 'More info' },
            index_js_eager_.createElement(help_icon, { noVerticalAlign: true })))) : (index_js_eager_.createElement(index_js_.Popover, Object.assign({ bodyContent: info }, popoverProps),
        index_js_eager_.createElement(index_js_.Button, { variant: "plain", "aria-label": ariaLabel || (typeof info === 'string' && info) || 'More info' },
            index_js_eager_.createElement(help_icon, { noVerticalAlign: true })))))));
...
;// CONCATENATED MODULE: ./node_modules/@patternfly/react-table/node_modules/@patternfly/react-icons/dist/esm/icons/long-arrow-alt-up-icon.js
...
const LongArrowAltUpIcon = (0,createIcon/* createIcon */.IU)(LongArrowAltUpIconConfig);

/* harmony default export */ const long_arrow_alt_up_icon = (LongArrowAltUpIcon);
;// CONCATENATED MODULE: ./node_modules/@patternfly/react-table/node_modules/@patternfly/react-icons/dist/esm/icons/long-arrow-alt-down-icon.js
...
const LongArrowAltDownIcon = (0,createIcon/* createIcon */.IU)(LongArrowAltDownIconConfig);

/* harmony default export */ const long_arrow_alt_down_icon = (LongArrowAltDownIcon);
;// CONCATENATED MODULE: ./node_modules/@patternfly/react-table/node_modules/@patternfly/react-icons/dist/esm/icons/arrows-alt-v-icon.js
...
const ArrowsAltVIcon = (0,createIcon/* createIcon */.IU)(ArrowsAltVIconConfig);

/* harmony default export */ const arrows_alt_v_icon = (ArrowsAltVIcon);
...
const SortColumn = (_a) => {
    var { children = null, className = '', isSortedBy = false, onSort = null, sortDirection = '', type = 'button' } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["children", "className", "isSortedBy", "onSort", "sortDirection", "type"]);
    let SortedByIcon;
    if (isSortedBy) {
        SortedByIcon = sortDirection === SortByDirection.asc ? long_arrow_alt_up_icon : long_arrow_alt_down_icon;
    }
    else {
        SortedByIcon = arrows_alt_v_icon;
    }
    return (index_js_eager_.createElement("button", Object.assign({}, props, { type: type, className: (0,esm/* css */.i)(className, table/* default.tableButton */.Z.tableButton), onClick: event => onSort && onSort(event) }),
        index_js_eager_.createElement("div", { className: (0,esm/* css */.i)(className, table/* default.tableButtonContent */.Z.tableButtonContent) },
            index_js_eager_.createElement(TableText, null, children),
            index_js_eager_.createElement("span", { className: (0,esm/* css */.i)(table/* default.tableSortIndicator */.Z.tableSortIndicator) },
...
const sortable = (label, { columnIndex, column, property, className, ariaLabel }) => {
    ...
    return {
        className: (0,esm/* css */.i)(table/* default.tableSort */.Z.tableSort, isSortedBy && table/* default.modifiers.selected */.Z.modifiers.selected, className),
...
const SelectColumn = (_a) => {
    var { children = null, 
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    className, onSelect = null, selectVariant } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["children", "className", "onSelect", "selectVariant"]);
...
const selectable = (label, { rowIndex, columnIndex, rowData, column, property }) => {
    ...
    return {
        className: (0,esm/* css */.i)(table/* default.tableCheck */.Z.tableCheck),
        component: 'td',
...
const cellWidth = (width) => () => ({
    className: (0,esm/* css */.i)(table/* default.modifiers */.Z.modifiers[typeof width === 'number' ? `width_${width}` : `width${capitalize(width)}`])
});
...
const ThBase = (_a) => {
    var { children, className, component = 'th', dataLabel, scope = 'col', textCenter = false, sort = null, modifier, select = null, tooltip = '', onMouseEnter: onMouseEnterProp = () => { }, width, visibility, innerRef, info: infoProps } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["children", "className", "component", "dataLabel", "scope", "textCenter", "sort", "modifier", "select", "tooltip", "onMouseEnter", "width", "visibility", "innerRef", "info"]);
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    isVisible = null, className: mergedClassName = '', component: MergedComponent = component } = merged, mergedProps = (0,tslib_es6/* __rest */._T)(merged, ["children", "isVisible", "className", "component"]);
    const cell = (index_js_eager_.createElement(MergedComponent, Object.assign({ "data-label": dataLabel, onMouseEnter: tooltip !== null ? onMouseEnter : onMouseEnterProp, scope: component === 'th' && children ? scope : null, ref: innerRef, className: (0,esm/* css */.i)(className, textCenter && table/* default.modifiers.center */.Z.modifiers.center, modifier && table/* default.modifiers */.Z.modifiers[modifier], mergedClassName) }, mergedProps, props), transformedChildren));
    ...
    render() {
        ...
        return (index_js_eager_.createElement(index_js_eager_.Fragment, null,
            items
                ...
                // eslint-disable-next-line @typescript-eslint/no-unused-vars
                .map((_a, key) => {
                var { title, itemKey, onClick, isOutsideDropdown } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["title", "itemKey", "onClick", "isOutsideDropdown"]);
            ...
            index_js_eager_.createElement(Dropdown/* Dropdown */.L, Object.assign({ toggle: actionsToggleClone, position: dropdownPosition, direction: dropdownDirection, isOpen: isOpen, dropdownItems: items
                    .filter(item => !item.isOutsideDropdown)
                    .map((_a, key) => {
                    var { title, itemKey, onClick, isSeparator } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["title", "itemKey", "onClick", "isSeparator"]);
...
const cellActions = (actions, actionResolver, areActionsDisabled) => (label, { rowData, column, rowIndex, columnIndex, column: { extraParams: { dropdownPosition, dropdownDirection, actionsToggle } }, property }) => {
    ...
    const renderProps = resolvedActions && resolvedActions.length > 0
        ...
        : {};
    return Object.assign({ className: (0,esm/* css */.i)(table/* default.tableAction */.Z.tableAction), style: { width: 'auto', paddingRight: 0 }, isVisible: true }, renderProps);
};
...
const CollapseColumn = (_a) => {
    var { className = '', children = null, isOpen, onToggle } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["className", "children", "isOpen", "onToggle"]);
    return (index_js_eager_.createElement(index_js_eager_.Fragment, null,
        isOpen !== undefined && (index_js_eager_.createElement(Button/* Button */.zx, Object.assign({ className: (0,esm/* css */.i)(className, isOpen && table/* default.modifiers.expanded */.Z.modifiers.expanded) }, props, { variant: "plain", "aria-label": "Details", onClick: onToggle, "aria-expanded": isOpen }),
            index_js_eager_.createElement("div", { className: (0,esm/* css */.i)(table/* default.tableToggleIcon */.Z.tableToggleIcon) },
...
const ExpandableRowContent = (_a) => {
    ...
    return (index_js_eager_.createElement("div", Object.assign({}, props, { className: (0,esm/* css */.i)(table/* default.tableExpandableRowContent */.Z.tableExpandableRowContent) }), children));
};
...
const collapsible = (value, { rowIndex, columnIndex, rowData, column, property }) => {
    ...
    return {
        className: rowData.isOpen !== undefined && (0,esm/* css */.i)(table/* default.tableToggle */.Z.tableToggle),
...
const expandedRow = (colSpan) => {
    const expandedRowFormatter = (value, { columnIndex, rowIndex, rowData, column: { extraParams: { contentId = 'expanded-content' } } }) => value &&
        ...
        className: rowData.noPadding && (0,esm/* css */.i)(table/* default.modifiers.noPadding */.Z.modifiers.noPadding)
    };
...
const compoundExpand = (value, { rowIndex, columnIndex, rowData, column, property }) => {
    ...
    return {
        className: (0,esm/* css */.i)(table/* default.tableCompoundExpansionToggle */.Z.tableCompoundExpansionToggle, props.isOpen && table/* default.modifiers.expanded */.Z.modifiers.expanded),
        children: props.isOpen !== undefined && (index_js_eager_.createElement("button", { type: "button", className: (0,esm/* css */.i)(table/* default.tableButton */.Z.tableButton), onClick: onToggle, "aria-expanded": props.isOpen, "aria-controls": props.ariaControls },
...
const FavoritesCell = (_a) => {
    var { className = '', onFavorite, isFavorited, rowIndex } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["className", "onFavorite", "isFavorited", "rowIndex"]);
...
const favoritable = (value, { rowIndex, columnIndex, rowData, column, property }) => {
    ...
    return {
        className: (0,esm/* css */.i)(table/* default.tableFavorite */.Z.tableFavorite, rowData && rowData.favorited && table/* default.modifiers.favorited */.Z.modifiers.favorited),
        isVisible: !rowData || !rowData.fullWidth,
...
;// CONCATENATED MODULE: ./node_modules/@patternfly/react-table/node_modules/@patternfly/react-icons/dist/esm/icons/ellipsis-h-icon.js
...
const EllipsisHIcon = (0,createIcon/* createIcon */.IU)(EllipsisHIconConfig);

/* harmony default export */ const ellipsis_h_icon = (EllipsisHIcon);
...
const treeRow = (onCollapse, onCheckChange, onToggleRowDetails) => (value, { rowIndex, rowData }) => {
    ...
    const text = (index_js_eager_.createElement("div", { className: (0,esm/* css */.i)(table_tree_view/* default.tableTreeViewText */.Z.tableTreeViewText) },
        icon && index_js_eager_.createElement("span", { className: (0,esm/* css */.i)(table_tree_view/* default.tableTreeViewIcon */.Z.tableTreeViewIcon) }, icon),
    ...
    return {
        ...
        children: level !== undefined ? (index_js_eager_.createElement("div", { className: (0,esm/* css */.i)(table_tree_view/* default.tableTreeViewMain */.Z.tableTreeViewMain) },
            setsize > 0 && (index_js_eager_.createElement("span", { className: (0,esm/* css */.i)(table_tree_view/* default.tableToggle */.Z.tableToggle) },
                index_js_eager_.createElement(index_js_.Button, { variant: "plain", onClick: event => onCollapse && onCollapse(event, rowIndex, content, rowData), className: (0,esm/* css */.i)(isExpanded && table/* default.modifiers.expanded */.Z.modifiers.expanded), "aria-expanded": isExpanded, "aria-label": toggleAriaLabel || `${isExpanded ? 'Collapse' : 'Expand'} row ${rowIndex}` },
                    index_js_eager_.createElement("div", { className: (0,esm/* css */.i)(table_tree_view/* default.tableToggleIcon */.Z.tableToggleIcon) },
                        index_js_eager_.createElement(angle_down_icon/* default */.ZP, { "aria-hidden": "true" }))))),
            !!onCheckChange && (index_js_eager_.createElement("span", { className: (0,esm/* css */.i)(table_tree_view/* default.tableCheck */.Z.tableCheck) },
            ...
            text,
            !!onToggleRowDetails && (index_js_eager_.createElement("span", { className: (0,esm/* css */.i)(table_tree_view/* default.tableTreeViewDetailsToggle */.Z.tableTreeViewDetailsToggle) },
                index_js_eager_.createElement(index_js_.Button, { variant: "plain", "aria-expanded": isDetailsExpanded, "aria-label": showDetailsAriaLabel || 'Show row details', onClick: event => onToggleRowDetails && onToggleRowDetails(event, rowIndex, content, rowData) },
                    index_js_eager_.createElement("span", { className: "pf-c-table__details-toggle-icon" },
                        index_js_eager_.createElement(ellipsis_h_icon, { "aria-hidden": true }))))))) : (text)
    };
};
...
const TdBase = (_a) => {
    var { children, className, component = 'td', dataLabel, textCenter = false, modifier, select = null, actions = null, expand = null, treeRow: treeRowProp = null, compoundExpand: compoundExpandProp = null, noPadding, width, visibility, innerRef, favorites = null } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["children", "className", "component", "dataLabel", "textCenter", "modifier", "select", "actions", "expand", "treeRow", "compoundExpand", "noPadding", "width", "visibility", "innerRef", "favorites"]);
    const selectParams = select
        ? selectable(children, {
    ...
    // selectable adds this but we don't want it
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    isVisible = null, children: mergedChildren = null, className: mergedClassName = '', component: MergedComponent = component } = merged, mergedProps = (0,tslib_es6/* __rest */._T)(merged, ["isVisible", "children", "className", "component"]);
    ...
    return (index_js_eager_.createElement(MergedComponent, Object.assign({}, (!treeTableTitleCell && { 'data-label': dataLabel }), { className: (0,esm/* css */.i)(className, textCenter && table/* default.modifiers.center */.Z.modifiers.center, noPadding && table/* default.modifiers.noPadding */.Z.modifiers.noPadding, table/* default.modifiers */.Z.modifiers[modifier], mergedClassName), ref: innerRef }, mergedProps, props), mergedChildren || children));
};
...
/* provided dependency */ var provider_console = __webpack_require__(25108);
...
class Provider extends index_js_eager_.Component {
    render() {
        const _a = this.props, { columns, renderers, components, children } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["columns", "renderers", "components", "children"]);
        let finalRenderers = renderers;
        if (components) {
            // eslint-disable-next-line no-console
            provider_console.warn('`components` have been deprecated in favor of `renderers` and will be removed in the next major version, please rename!');
...
const BodyCell = (_a) => {
    ...
    props = (0,tslib_es6/* __rest */._T)(_a, ['data-label', "className", "colSpan", "component", "isVisible", "parentId", "textCenter", "tooltip", "onMouseEnter", "children", "errorText", "isValid", "isOpen", "ariaControls", "editableValue", "editableSelectProps", "options", "isSelectOpen", "value", "name"]);
    const [tooltip, setTooltip] = index_js_eager_.useState('');
    const onMouseEnter = (event) => {
        if (event.target.offsetWidth < event.target.scrollWidth) {
            if (tooltipProp) {
    ...
    const cell = (index_js_eager_.createElement(Td, Object.assign({ className: className, component: component, dataLabel: dataLabel && !parentId ? dataLabel : null, onMouseEnter: onMouseEnter, textCenter: textCenter, colSpan: colSpan }, props), children));
...
const HeaderCell = (_a) => {
    ...
    /* eslint-enable @typescript-eslint/no-unused-vars */
    props = (0,tslib_es6/* __rest */._T)(_a, ["className", "component", "scope", "textCenter", "tooltip", "onMouseEnter", "children", "isVisible", "dataLabel"]);
...
class RowWrapper extends index_js_eager_.Component {
    ...
    render() {
        ...
        /* eslint-enable @typescript-eslint/no-unused-vars */
        trRef, className, ouiaId } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["onScroll", "onResize", "row", "rowProps", "trRef", "className", "ouiaId"]);
...
;// CONCATENATED MODULE: ./node_modules/@patternfly/react-table/node_modules/@patternfly/react-icons/dist/esm/icons/pencil-alt-icon.js
...
const PencilAltIcon = (0,createIcon/* createIcon */.IU)(PencilAltIconConfig);

/* harmony default export */ const pencil_alt_icon = (PencilAltIcon);
...
const EditColumn = (_a) => {
    ...
    /* eslint-enable @typescript-eslint/no-unused-vars */
    saveAriaLabel, cancelAriaLabel, editAriaLabel } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["onClick", "className", "editing", "valid", "saveAriaLabel", "cancelAriaLabel", "editAriaLabel"]);
    return (index_js_eager_.createElement(index_js_eager_.Fragment, null,
        index_js_eager_.createElement("div", { className: (0,esm/* css */.i)(inline_edit/* default.inlineEditGroup */.Z.inlineEditGroup, inline_edit/* default.modifiers.iconGroup */.Z.modifiers.iconGroup, 'pf-m-action-group') },
            index_js_eager_.createElement("div", { className: (0,esm/* css */.i)(inline_edit/* default.inlineEditAction */.Z.inlineEditAction) },
        ...
        index_js_eager_.createElement("div", { className: (0,esm/* css */.i)(inline_edit/* default.inlineEditAction */.Z.inlineEditAction, inline_edit/* default.modifiers.enableEditable */.Z.modifiers.enableEditable) },
            index_js_eager_.createElement(Button/* Button */.zx, Object.assign({ "aria-label": editAriaLabel }, props, { onClick: e => onClick(e, 'edit'), variant: "plain" }),
                index_js_eager_.createElement(pencil_alt_icon, null)))));
};
...
const BodyWrapper = (_a) => {
    ...
    /* eslint-enable @typescript-eslint/no-unused-vars */
    props = (0,tslib_es6/* __rest */._T)(_a, ["mappedRows", "tbodyRef", "rows", "onCollapse", "headerRows"]);
...
const TreeRowWrapper = (_a) => {
    var { className, 
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    rowProps, row } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["className", "rowProps", "row"]);
    const { 'aria-level': level, 'aria-posinset': posinset, 'aria-setsize': setsize, isExpanded, isDetailsExpanded, isHidden } = row.props;
    return (index_js_eager_.createElement(Tr, Object.assign({ "aria-level": level, "aria-posinset": posinset, "aria-setsize": setsize, "aria-expanded": !!isExpanded, isHidden: isHidden, className: (0,esm/* css */.i)(className, isExpanded && table/* default.modifiers.expanded */.Z.modifiers.expanded, isDetailsExpanded && table_tree_view/* default.modifiers.treeViewDetailsExpanded */.Z.modifiers.treeViewDetailsExpanded) }, props)));
};
...
/* provided dependency */ var Table_console = __webpack_require__(25108);
...
class Table extends index_js_eager_.Component {
    ...
    componentDidMount() {
        if (this.props.onRowEdit && "production" !== 'production' && !Table.hasWarnBeta) {
            // eslint-disable-next-line no-console
            Table_console.warn('You are using a beta component feature (onRowEdit). These api parts are subject to change in the future.');
            Table.hasWarnBeta = true;
        }
    }
    render() {
        const _a = this.props, { 'aria-label': ariaLabel, caption, header, onSort, onSelect, canSelectAll, selectVariant, sortBy, children, actions, actionResolver, areActionsDisabled, onCollapse, onExpand, onRowEdit, rowLabeledBy, dropdownPosition, dropdownDirection, actionsToggle, contentId, expandId, variant, rows, cells, bodyWrapper, rowWrapper, role, borders, onFavorite, canSortFavorites } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ['aria-label', "caption", "header", "onSort", "onSelect", "canSelectAll", "selectVariant", "sortBy", "children", "actions", "actionResolver", "areActionsDisabled", "onCollapse", "onExpand", "onRowEdit", "rowLabeledBy", "dropdownPosition", "dropdownDirection", "actionsToggle", "contentId", "expandId", "variant", "rows", "cells", "bodyWrapper", "rowWrapper", "role", "borders", "onFavorite", "canSortFavorites"]);
        if (!ariaLabel && !caption && !header && role !== 'presentation') {
            // eslint-disable-next-line no-console
            Table_console.error('Table: Specify at least one of: header, caption, aria-label');
        }
        ...
        const table = (index_js_eager_.createElement(TableContext.Provider, { value: {
            ...
            index_js_eager_.createElement(Provider, Object.assign({}, props, { "aria-label": ariaLabel, renderers: {
                ...
                children)));
        if (onRowEdit) {
            return index_js_eager_.createElement("form", { className: (0,esm/* css */.i)(inline_edit/* default.inlineEdit */.Z.inlineEdit) }, table);
        }
        return table;
    }
}
...
/* provided dependency */ var body_row_console = __webpack_require__(25108);
/**
 * body-row.tsx
 *
 * Forked from reactabular-table version 8.14.0
...
class BodyRow extends index_js_eager_.Component {
    ...
    render() {
        ...
        return index_js_eager_.createElement(renderers.row, onRow(rowData, { rowIndex, rowKey }), columns.map((column, columnIndex) => {
            ...
            if (!transformed) {
                // eslint-disable-next-line no-console
                body_row_console.warn('Table.Body - Failed to receive a transformed result');
            }
...
class BaseBody extends index_js_eager_.Component {
    constructor() {
        ...
        this.omitOnRow = (props) => {
            // eslint-disable-next-line @typescript-eslint/no-unused-vars
            const { onRow } = props, ret = (0,tslib_es6/* __rest */._T)(props, ["onRow"]);
            return ret;
        };
    }
    shouldComponentUpdate(nextProps) {
    ...
    render() {
        const _a = this.props, { onRow, rows, rowKey, columns, renderers } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["onRow", "rows", "rowKey", "columns", "renderers"]);
...
class ContextBody extends index_js_eager_.Component {
    ...
    render() {
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const _a = this.props, { className, headerData, rows, rowKey, children, onRowClick } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["className", "headerData", "rows", "rowKey", "children", "onRowClick"]);
        let mappedRows;
...
const TableBody = (_a) => {
    ...
    /* eslint-enable @typescript-eslint/no-unused-vars */
    undefined } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["className", "children", "rowKey", "onRow", "onRowClick"]);
    return (index_js_eager_.createElement(TableContext.Consumer, null, (_a) => {
        var { headerData = [], rows = [] } = _a, rest = (0,tslib_es6/* __rest */._T)(_a, ["headerData", "rows"]);
...
const EditableSelectInputCell = ({ value, rowIndex, cellIndex, onSelect = () => { }, clearSelection, isOpen = false, onToggle = () => { }, selections = [''], options = [], props }) => {
    ...
    return (index_js_eager_.createElement(index_js_eager_.Fragment, null,
        ...
        index_js_eager_.createElement("div", { className: inline_edit/* default.inlineEditInput */.Z.inlineEditInput },
            select,
            index_js_eager_.createElement("div", { className: (0,esm/* css */.i)(Form_form/* default.formHelperText */.Z.formHelperText, Form_form/* default.modifiers.error */.Z.modifiers.error), "aria-live": "polite" }, props.errorText))));
};
...
/* provided dependency */ var header_row_console = __webpack_require__(25108);
/**
 * header-row.tsx
 *
 * Forked from reactabular-table version 8.14.0
...
const HeaderRow = ({ rowData, rowIndex, renderers, onRow = () => Object }) => index_js_eager_.createElement(renderers.row, onRow(rowData, { rowIndex }), rowData.map((column, columnIndex) => {
    ...
    if (!transformedProps) {
        ...
        header_row_console.warn('Table.Header - Failed to receive a transformed result'); // eslint-disable-line max-len, no-console
    }
    let cellNode;
...
class BaseHeader extends index_js_eager_.Component {
    render() {
        const _a = this.props, { children, headerRows, onRow, renderers, columns } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["children", "headerRows", "onRow", "renderers", "columns"]);
...
const ContextHeader = (_a) => {
    var { className = '', headerRows = undefined } = _a, props = (0,tslib_es6/* __rest */._T)(_a, ["className", "headerRows"]);
...
var cloneArrayBuffer = __webpack_require__(40214);
...
//# sourceMappingURL=686.bundle.0b0b2f35c4cb05102009.js.map