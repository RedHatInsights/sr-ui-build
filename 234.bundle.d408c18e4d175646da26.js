"use strict";
(self["webpackChunk_apicurio_registry_ui"] = self["webpackChunk_apicurio_registry_ui"] || []).push([[234],{
...
/* harmony import */ var _components_artifactList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(84270);
/* harmony import */ var _basePage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(26619);
/* harmony import */ var _components_toolbar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(80941);
/* harmony import */ var _components_empty__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(73243);
/* harmony import */ var _components_uploadForm__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(70150);
/* harmony import */ var _components_modals__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(49746);
/* harmony import */ var _components_common_if__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(24754);
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(46768);
/* harmony import */ var _components_modals_pleaseWaitModal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(38304);
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(60553);
/**
 * @license
...
var ArtifactsPage = /** @class */ (function (_super) {
    ...
    function ArtifactsPage(props) {
        ...
        _this.doUploadArtifact = function () {
            ...
            if (_this.state.uploadFormData !== null) {
                ...
                _services__WEBPACK_IMPORTED_MODULE_9__.Services.getGroupsService().createArtifact(_this.state.uploadFormData).then(function (metaData) {
                    ...
                    _services__WEBPACK_IMPORTED_MODULE_9__.Services.getLoggerService().info("[ArtifactsPage] Artifact successfully uploaded.  Redirecting to details: ", artifactLocation);
    ...
    ArtifactsPage.prototype.renderPage = function () {
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageSection, { className: "ps_artifacts-header", variant: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageSectionVariants.light, padding: { default: "noPadding" } },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_11__/* .RootPageHeader */ .N4, { tabKey: 0 })),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_common_if__WEBPACK_IMPORTED_MODULE_8__.If, { condition: this.showToolbar },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageSection, { variant: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageSectionVariants.light, padding: { default: "noPadding" } },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_toolbar__WEBPACK_IMPORTED_MODULE_4__/* .ArtifactsPageToolbar */ .U, { artifacts: this.results(), paging: this.state.paging, onPerPageSelect: this.onPerPageSelect, onSetPage: this.onSetPage, onUploadArtifact: this.onUploadArtifact, onChange: this.onFilterChange }))),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageSection, { variant: _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.PageSectionVariants["default"], isFilled: true }, this.artifactsCount() === 0 ?
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_empty__WEBPACK_IMPORTED_MODULE_5__/* .ArtifactsPageEmptyState */ .B, { onUploadArtifact: this.onUploadArtifact, isFiltered: this.isFiltered() })
                :
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_artifactList__WEBPACK_IMPORTED_MODULE_2__/* .ArtifactList */ .ye, { artifacts: this.artifacts(), onGroupClick: this.onGroupClick }))),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Modal, { title: "Upload Artifact", variant: "large", isOpen: this.state.isUploadModalOpen, onClose: this.onUploadModalClose, className: "upload-artifact-modal pf-m-redhat-font", actions: [
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_uploadForm__WEBPACK_IMPORTED_MODULE_6__/* .UploadArtifactForm */ .k, { onChange: this.onUploadFormChange, onValid: this.onUploadFormValid })),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_modals__WEBPACK_IMPORTED_MODULE_7__/* .InvalidContentModal */ .R, { error: this.state.invalidContentError, isOpen: this.state.isInvalidContentModalOpen, onClose: this.closeInvalidContentModal }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_modals_pleaseWaitModal__WEBPACK_IMPORTED_MODULE_10__/* .PleaseWaitModal */ .j, { message: "Creating artifact, please wait...", isOpen: this.state.isPleaseWaitModalOpen })));
    };
    ...
    ArtifactsPage.prototype.search = function () {
        var _this = this;
        return _services__WEBPACK_IMPORTED_MODULE_9__.Services.getGroupsService().getArtifacts(this.state.criteria, this.state.paging).then(function (results) {
    ...
    ArtifactsPage.prototype.handleInvalidContentError = function (error) {
        _services__WEBPACK_IMPORTED_MODULE_9__.Services.getLoggerService().info("INVALID CONTENT ERROR", error);
        this.setMultiState({
...
/* harmony import */ var _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(90847);
/* harmony import */ var _patternfly_react_core__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(60553);
...
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(60553);
    ...
    ArtifactsPageToolbar.prototype.render = function () {
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.Toolbar, { id: "artifacts-toolbar-1", className: "artifacts-toolbar" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.ToolbarContent, null,
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core__WEBPACK_IMPORTED_MODULE_1__.ToolbarItem, { className: "upload-artifact-item" },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_3__/* .IfAuth */ .No, { isDeveloper: true },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_3__/* .IfFeature */ .QT, { feature: "readOnly", isNot: true },
...
/* harmony import */ var _models__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(19162);
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
//# sourceMappingURL=234.bundle.d408c18e4d175646da26.js.map